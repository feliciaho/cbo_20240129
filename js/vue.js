    ...
    return {
      ...
      rewardList1: [
        ...
        },
        {
          ...
          description: "攻擊力+30、防禦力+30、刀劍技能增幅+5%，持續30分鐘。",
        },
        {
          actDate: "2/13",
        ...
        },
        {
          ...
          description: "使用後所有異常狀態的抵抗能力+30%，持續30分鐘。",
        },
        {
          actDate: "2/17",
          item_name: "英雄的召喚x5",
        ...
        },
        {
          actDate: "2/18",
          item_name: "英雄的跳躍x5",
          description: "蘊藏古代魔力的卷軸。具有傳送至指定隊員位置的功能。",
        },
        {
          actDate: "2/19",
    ...
    async getSetting() {
      try {
        ...
        if (response.data.status == -90) {
          ...
          this.logIn.account = response.data.account;
          ...
          try {
            ...
            if (response.data.status == -98) {
              ...
              this.popS.wrapText =
                ...
                "分";
              this.popS.butText1 = "<div class='popBut1' >晚點再來</div>";
              this.openPop();
    ...
    async history(type) {
      try {
        ...
        response = {
          data: {
            ...
            list1: [
              {
                coupon: "7.5折優惠券A",
                coupon_deadline: "2024/02/06 10:00",
                item: "貝拉德里克斯的加護x10",
              },
              {
                coupon: "5折優惠券B",
        ...
        if (response.data.status == 1) {
          if (type === "pray") {
            this.claimHistory1 = response.data.list1;
          } else if (type === "bless") {
            this.claimHistory2 = response.data.list2;
          }
        }
      } catch (err) {
        console.log(err);
...
// app.component('loading', VueLoading.Loading);
